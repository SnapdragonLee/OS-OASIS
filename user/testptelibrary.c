...
void umain(int argc, char **argv) {
    ...
    if ((r = syscall_mem_alloc(0, (u_int)TMPVA, (u_int)(PTE_R | PTE_V | PTE_LIBRARY))) < 0)
    ...
    } else { user_panic("sorry , your fork may be wrong\n"); }
    ...
    } else { user_panic("sorry , your spawn may be wrong\n"); }
}
